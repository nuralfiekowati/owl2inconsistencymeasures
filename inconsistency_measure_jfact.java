...
public class inconsistency_measure_jfact {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			File file = new File("output_jfact_.txt");
			...
			OWLReasoner reasoner = rf.createReasoner(ontology, configuration); // for
																				...
																				// and
																				// JFact
			// OWLReasoner reasoner=rf.createReasoner(ontology); //for jfact but
			// this uses hermit functional
			...
			OWLReasonerFactory rf6 = new JFactFactory(); // for jfact
			...
			OWLReasonerFactory rf3 = new JFactFactory(); // for jfact
			...
			OWLReasonerFactory rf5 = new JFactFactory(); // for jfact
